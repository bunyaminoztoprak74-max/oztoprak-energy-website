...
export function Header({ locale, dict }: { locale: Locale; dict: Dict }) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[rgba(7,17,31,0.94)] shadow-[0_12px_40px_rgba(0,0,0,0.22)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-1.5 sm:px-6 sm:py-2 lg:px-8">
        <Link
          href={`/${locale}`}
          className="flex max-h-[52px] min-w-0 items-center transition hover:opacity-90"
