...
export const projects: Record<Locale, Project[]> = {
  en: [
    ...
    {
      slug: "industrial-electricity-cost-optimization-case-study",
      title: "Industrial Electricity Cost Optimization Case Study",
      category: "Energy cost optimization case study",
      capacity: "6,200 kW contracted demand",
      location: "Anonymized industrial facility, Turkey",
      type: "Industrial facility — mixed process",
      role: "Energy cost advisor",
      summary: "Anonymized industrial electricity cost optimization engagement covering reactive penalty elimination, contract power realignment and rooftop solar feasibility review for a mid-size manufacturing facility.",
      scope: ["12-month electricity bill decomposition", "Reactive power penalty analysis", "Compensation system inspection", "Contract demand profile review", "Rooftop solar self-consumption modeling"],
      commissioning: "The facility had no formal baseline for electricity cost components. The engagement established a cost decomposition model that separated reactive penalties, demand charges, energy tariff and distribution charges across the 12-month review period.",
      om: "Ongoing cost monitoring recommendations were provided including monthly reactive penalty tracking, demand interval alerting and a schedule for compensation system inspection after the initial corrective works.",
      ...
      beforeAfterMetrics: [
        ...
        { label: "Total bill reduction", before: "Baseline", after: "16% lower", impact: "Combined reactive and demand optimization reduced the total monthly electricity bill by 16% with no production process changes and no active energy efficiency investment." }
      ],
      faqs: [
        { question: "Can reactive penalties be permanently eliminated?", answer: "Yes, provided the compensation system is correctly sized for both the required reactive capacity and the harmonic environment. A system designed for fixed capacitor banks in a facility with VFD loads will have reliability problems that allow penalties to return." },
        { question: "Does re-contracting to a lower power level carry risk?", answer: "It does require careful analysis of the peak demand distribution. The contracted level should include adequate headroom above the measured 99th-percentile demand to avoid excess demand events during production peaks." },
        { question: "Is rooftop solar always financially justified for industrial facilities?", answer: "Not always. It depends on the self-consumption ratio, which is driven by the match between daytime generation and daytime consumption. The feasibility model must use actual hourly data, not aggregate monthly consumption." }
      ]
    }
  ],
  tr: [
    ...
    {
      slug: "endustriyel-elektrik-maliyet-optimizasyonu-vaka-calismasi",
      title: "Endustriyel Elektrik Maliyet Optimizasyonu Vaka Calismasi",
      category: "Enerji maliyet optimizasyonu vaka calismasi",
      capacity: "6.200 kW sozlesme gucu",
      location: "Anonim sanayi tesisi, Turkiye",
      type: "Sanayi tesisi — karisik proses",
      role: "Enerji maliyet danismani",
      summary: "Orta olcekli bir imalat tesisi icin reaktif ceza giderme, sozlesme gucu uyumlastirma ve cati GES fizibilite incelemesini kapsayan anonim sanayi elektrik maliyet optimizasyonu calismasi.",
      scope: ["12 aylik elektrik faturasi ayrismasi", "Reaktif guc ceza analizi", "Kompanzasyon sistemi incelemesi", "Sozlesme talep profili incelemesi", "Cati GES oz tuketim modellemesi"],
      commissioning: "Tesisin elektrik maliyet bilesenleri icin resmi bir baz olmadigi tespit edildi. Calisma, reaktif cezalari, talep ucretleri, enerji tarifesi ve dagitim ucretlerini 12 aylik inceleme donemi boyunca ayiran bir maliyet ayrima modeli olusturdu.",
      om: "Reaktif ceza takibi, talep araligi izleme ve ilk duzeltici calismalardan sonra kompanzasyon sistemi icin denetim takvimi de dahil olmak uzere suregelen maliyet izleme onerileri sunuldu.",
      challenge: "Tesisin elektrik faturasi yildan yila onemli olcude artmisti; ancak finans ekibi hangi maliyet bilesenlerin kontrol edilebilir, hangilerinin uretim artisiyla ilgili oldugunu belirleyemiyordu.",
      approach: "Calisma, her maliyet bileseni ayri olarak nicellestiren 12 aylik fatura ayrismasi ile basladi. Reaktif cezalarin toplam elektrik maliyetinin yuzde onbirini olusturdugu ve bunun sekiz hiz kontrol surucusu tarafindan uretilen harmoniklere yanit veremeyen yetersiz ve kismen arizali bir kompanzasyon panelinden kaynaklandigi belirlendi. Talep analizi, sozlesme gucunun olculen 99. percentil pik talepten 380 kW yuksek belirlendigini gosterdi.",
      actions: [
        "12 aylik elektrik faturasi reaktif ceza, talep ucreti, enerji tarifesi ve dagitim bilesenlere ayrismasi yapildi",
        "Mevcut kompanzasyon panosu incelendi; iki arizali kondansator bank ve HKS yukunden kaynakli harmonik rezonans tespit edildi",
        "Olculen reaktif talep ve harmonik spetrum icin boyutlandirilmis detunlu kompanzasyon sistemi spesifike edildi",
        "Sozlesme gucunu 6.200 kW'tan 5.820 kW'a dusurme basvurusu hazirlandi",
        "Saatlik tuketim verisi ve tesisin guneye bakan cati alani kullanilarak uc sistem boyutu senaryosunda cati GES verimi modellendi",
        "Her senaryo icin mevcut tarife kapsaminda oz tuketim orani ve geri odeme hesaplandi"
      ],
      results: [
        "Reaktif cezalar aylik elektrik maliyetinin yuzde onbirinden yuzde 0,5'in altina dustu",
        "Yeniden sozlesme aylik kapasite ucretlerini yaklasik yuzde yedi azaltti",
        "Reaktif ve talep optimizasyonunun birlesmesiyle hicbir proses veya uretim degisikligi olmadan toplam aylik elektrik faturasi yuzde on alti azaldi",
        "Mevcut tarife kapsaminda 5,8 yil geri odeme sureciyle yuzde 74 oz tuketim orani saglayan 480 kWp sistem icin cati GES fizibilitesi onaylandi"
      ],
      lessons: [
        "Reaktif cezalar cogunlukla en hizli geri odeme saglayan iyilestirmedir; cunku neden genellikle proses degisikligi gerektirmeden duzeltilen arizali veya yetersiz bir kompanzasyon sistemidir",
        "Sozlesme gucu incelemesi 12 aylik aralik talep verisi gerektirir; tek bir pik olcumu yeniden sozlesme kararlari icin yeterli degildir",
        "Cati GES fizibilitesi ancak oz tuketim orani saatlik uretim ve tuketim profillerinden hesaplandıginda anlamlidir",
        "Herhangi bir ekipman alimından once fatura ayrismasi, verimsizlik onlemleri uygulama hatasindan kacindirarak onlenebilir ceza maliyetleri devam ederken yatirim yapilmasini engeller"
      ],
      relatedServices: ["endustriyel-enerji-maliyet-optimizasyonu", "enerji-denetimi", "ges-danismanligi"],
      beforeAfterMetrics: [
        { label: "Reaktif cezanin faturadaki payi", before: "Yuzde 11,0", after: "Yuzde 0,4", impact: "Reaktif ceza giderme, kompanzasyon panosu degisimi ve detunlu reaktor korumasi araciligiyla aylik elektrik maliyetinin yaklasik yuzde 10,6'sini geri kazandi." },
        { label: "Aylik kapasite ucreti", before: "6.200 kW sozlesme", after: "5.820 kW sozlesme", impact: "Sozlesme gucu azaltma, 380 kW kullanilmayan kapasiteyi ortadan kaldirarak aylik kapasite ucreti bileseni yaklasik yuzde yedi dustu." },
        { label: "Toplam fatura azaltma", before: "Baz durum", after: "Yuzde 16 daha dusuk", impact: "Reaktif ve talep optimizasyonunun birlesmesiyle hicbir uretim sureci degisikligi ve aktif enerji verimlilik yatirimi yapilmadan toplam aylik elektrik faturasi yuzde 16 azalti." }
      ],
      faqs: [
        { question: "Reaktif cezalar kalici olarak ortadan kaldirilabilir mi?", answer: "Evet; yeter ki kompanzasyon sistemi hem gerekli reaktif kapasite hem de harmonik ortam icin dogru boyutlandirilmis olsun. HKS yuklu bir tesiste sabit kondansator bankalar icin tasarlanan sistem, cezalarin tekrar olusmasina izin veren guvenilirlik sorunlariyla karsilasir." },
        { question: "Daha dusuk bir guce yeniden sozlesme risk tasir mi?", answer: "Pik talep dagiliminin dikkatli analizi gerektirir. Sozlesme duzeyi, uretim piklarinda asim olaylarindan kacinmak icin olculen 99. percentil talebin uzerinde yeterli bosluk icermelidir." },
        { question: "Cati GES sanayi tesisleri icin her zaman finansal olarak gerceklestirilebilir mi?", answer: "Her zaman degildir. Gunduz uretimi ile gunduz tuketimi arasindaki eslesmeye bagli oz tuketim oranina baglidir. Fizibilite modeli toplam aylik tuketime degil gercek saatlik veriye dayanmalidir." }
      ]
    }
  ]
};
