...
export const blogPosts: Record<Locale, BlogPost[]> = {
  ...
  tr: [
    ...
    {
      slug: "edpk-aktif-guc-yonetimi-danismanligi",
      title: "EDPK ve Aktif Güç Yönetimi: Enerji Santralleri İçin Teknik Danışmanlık Rehberi",
      description: "Yenilenebilir enerji santrallerinde EDPK uyumu, aktif güç çıkışı yönetimi ve dengeleme piyasası katılımı için teknik danışmanlık rehberi.",
      category: "Şebeke ve Uyum",
      categorySlug: "sebeke-ve-uyum",
      date: "2026-07-09",
      readingTime: "10 dk",
      toc: ["EDPK nedir ve hangi santralleri kapsar", "Aktif güç çıkışı yönetiminde teknik gereksinimler", "AGC uyumu ve governor tepkisi", "EDPK uyumsuzluğunun maliyeti", "Teknik danışmanlık nasıl yardımcı olur"],
      related: ["agc-uyumu-danismanligi-hes-isletme", "sekonder-frekans-kontrolu-agc-hazirligi", "reaktif-guc-kontrolu-yenilenebilir-santraller"],
      serviceLinks: ["sebeke-koruma-sistemi-analizi", "hes-optimizasyonu", "enerji-santrali-devreye-alma"],
      body: [
        { heading: "EDPK nedir ve hangi santralleri kapsar", content: "EDPK (Etkin Güç Dengeleme ve Piyasa Katılımı) Türkiye elektrik piyasasında belirli kapasitelerin üzerindeki üretim santrallerinin dengeleme mekanizmasına aktif olarak katılma ve yük tevzi talimatlarını takip etme yükümlülüğünü tanımlar. Bu yükümlülük; hidroelektrik santraller (HES), güneş enerjisi santralleri (GES) ve rüzgar enerji santralleri (RES) dahil yenilenebilir enerji üreticilerini kapsamaktadır. Dengeleme piyasasına katılım ve aktif güç çıkışı yönetimi, santral işletmecilerinin TEİAŞ talimatlarına uyum sağlamasını, gerçek zamanlı güç çıkışını kontrol etmesini ve dengeleme sapma maliyetlerini minimize etmesini gerektirir. Kapasitesi belirli eşiğin üzerinde olan santraller için bu teknik yükümlülük, hem gelir optimizasyonu hem de piyasa uyum riski açısından kritik önem taşır." },
        { heading: "Aktif güç çıkışı yönetiminde teknik gereksinimler", content: "Etkin aktif güç yönetimi; SCADA sisteminin gerçek zamanlı üretim verisini doğru ölçmesini ve iletmesini, kumanda-kontrol sisteminin yük tevzi talimatlarını hızlı ve doğru şekilde takip etmesini, governor veya inverter kontrol parametrelerinin saha koşullarına göre doğru ayarlanmış olmasını gerektirir. HES için kritik gereksinimler arasında governor ayarları (droop, dead-band, ramp rate), AGC sinyali algılama ve işleme kapasitesi ile türbin kontrol sisteminin set noktası takip performansı yer alır. GES için aktif güç kontrolü, inverter aktif güç sınırlama modunun doğru yapılandırılmasını ve SCADA-inverter haberleşme bütünlüğünü gerektirir. Mevcut santrallerin bu gereksinimleri karşılayıp karşılamadığı sistematik teknik inceleme olmaksızın güvenilir biçimde değerlendirilemez." },
        { heading: "AGC uyumu ve governor tepkisi", content: "Otomatik Üretim Kontrolü (AGC/EDPK) uyumu, santral kontrol sisteminin TEİAŞ'tan gelen set noktası sinyaline tanımlanan yanıt süresi ve hassasiyet toleransları içinde cevap vermesini gerektirmektedir. HES santrallerinde governor tepkisi; ölü bant ayarı, rampa hızı ve dinamik stabilite açısından değerlendirilmelidir. Yetersiz governor yanıtı; sapma maliyetleri, dengeleme piyasasında olumsuz fiyatlama ve düzenleyici cezalar şeklinde sonuçlanabilir. Sahada sık karşılaşılan sorunlar arasında governor kontrol parametre kayması (zaman içinde oluşan ayar bozulması), SCADA ve kontrol sistemi arasındaki haberleşme gecikmeleri, akış kısıtlamaları nedeniyle yetersiz düzenleyici bant ve AGC uyumsuzluğuna yol açan devir sayısı (speed) kontrol sorunları sayılabilir. Bu sorunların çoğu sahada sistematik test yapılmadan tespit edilememektedir." },
        { heading: "EDPK uyumsuzluğunun maliyeti", content: "Aktif güç çıkışı yönetiminde yaşanan uyumsuzluk; dengeleme sapma maliyetleri, TEİAŞ yaptırımları ve piyasa katılım kısıtlamaları şeklinde doğrudan gelir kaybına dönüşebilir. Orta büyüklükte bir HES için aylık sapma maliyetleri önemli tutarlara ulaşabilmekte; uzun süre devam eden uyumsuzluk halinde ise idari yaptırım riski doğmaktadır. Daha az görünür olan maliyet ise fırsatın kaçırılmasıdır: iyi yapılandırılmış ve güvenilir biçimde dengeleme piyasasına katılabilen santraller ek gelir kanallarından yararlanabilmektedir. Teknik uyumsuzluk bu kanalı kapatır. Mevcut santral kontrol sisteminizin EDPK gereksinimlerini ne ölçüde karşıladığını değerlendirmek için sistematik teknik inceleme birinci adımdır." },
        { heading: "Teknik danışmanlık nasıl yardımcı olur", content: "Deneyimli bir teknik danışman EDPK uyum sürecini şu şekilde destekler: mevcut governor ve kontrol sistemi ayarlarının tasarım değerleriyle karşılaştırmalı incelemesi, SCADA-kontrol sistemi haberleşme bütünlüğü ve gecikme analizi, dengeleme testleri için prosedür hazırlanması ve test gözetimi, AGC uyumluluk testleri sırasında bağımsız teknik gözlem ve bulgulara dayalı öncelikli düzeltici aksiyon planı. Bu çalışma santral sahibine uyumsuzluk riskini niceliksel olarak ortaya koyan ve çözüm için net teknik yol haritası sunan bir çıktı paketi sağlar. Aktif güç yönetimi ve EDPK uyumu konusunda teknik inceleme talep etmek için iletişime geçin." }
      ],
      faqs: [
        { question: "EDPK hangi kapasitedeki santralleri kapsar?", answer: "Türkiye mevzuatında aktif güç yönetimi ve dengeleme katılım yükümlülükleri belirli kapasite eşiğinin üzerindeki santraller için geçerlidir. Güncel eşik değerler ve kapsamlar için TEİAŞ sistem işletim tebliğlerine başvurulmalıdır." },
        { question: "AGC uyum testi ne sıklıkla yapılmalıdır?", answer: "Büyük bakım veya ekipman değişikliğinin ardından, governor veya kontrol sistemi parametreleri değiştiğinde ve dengeleme sapma maliyetlerinde açıklanamayan artış gözlemlendiğinde yapılmalıdır. Düzenli kontrol en az yılda bir kez önerilir." },
        { question: "Mevcut santral EDPK gereksinimleri için yeniden yapılandırılabilir mi?", answer: "Çoğu durumda evet. Governor parametre optimizasyonu, kontrol sistemi yazılım güncellemesi veya SCADA haberleşme iyileştirmesi ile mevcut ekipman üzerinden uyum sağlanabilir. Fiziksel ekipman değişikliği nadiren gereklidir." }
      ]
    },
    {
